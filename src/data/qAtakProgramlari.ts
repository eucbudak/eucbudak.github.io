...
// Slot atama algoritmasi (4-adimli):
//   1) Sayisal dersler kendi sabit saat slotuna (13:10 Mat / 14:00 Fiz / 14:50 Kim / 15:40 Biy)
//      atanir; her dersin dolu gunlerine AYT-TYT alterne olarak konu havuzlarindan rotasyonla.
//      Boylece her hafta'da hem AYT hem TYT konulari isleniyor (zaman bazli ayrim yok).
//   2) Turkce, Excel'de Turkce dolu olan gunlerde BOS bir saat slotuna atanir.
//   3) Sayisal konu havuzundan yer bulamayanlar Turkce slotlarini isgal eder
//      (Turkce'den eleme).
//   4) Yine yer bulamayanlar build raporunda gosterilir.
  ...
  gunler: [
    ...
    },
    {
      ...
      saatler: [
        ...
        { saat: '14:00 – 14:50', ders: 'Fizik', sinav: 'TYT', konu: 'Elektrik Akımı (Ohm Yasası)', kapasite: 0 },
    ...
    },
    {
      ...
      saatler: [
        ...
        { saat: '14:00 – 14:50', ders: 'Fizik', sinav: 'AYT', konu: 'Sığa (Kapasite)', kapasite: 1 },
...
export const nazilliProgrami: Program = {
  ...
  gunler: [
    ...
    },
    {
      gun: 'Salı', tarih: '12 Mayıs', hafta: 1,
      saatler: [
        { saat: '13:10 – 14:00', ders: 'Matematik', sinav: 'TYT', konu: 'Sayı Problemleri', kapasite: 1 },
        { saat: '14:00 – 14:50', ders: 'Fizik', sinav: 'TYT', konu: 'Newton\'ın Hareket Yasaları', kapasite: 1 },
        { saat: '14:50 – 15:40', ders: 'Kimya', sinav: 'AYT', konu: 'Esterler', kapasite: 1 },
        { saat: '15:40 – 16:30', ders: 'Matematik', sinav: 'AYT', konu: 'Maksimum-Minimum Problemleri', kapasite: 1 },
      ],
    },
    {
      gun: 'Çarşamba', tarih: '13 Mayıs', hafta: 1,
    ...
    },
    {
      ...
      saatler: [
        ...
        { saat: '14:00 – 14:50', ders: 'Matematik', sinav: 'TYT', konu: 'Emek (İşçi-Havuz) Problemleri', kapasite: 1 },
        { saat: '14:50 – 15:40', ders: 'Kimya', sinav: 'AYT', konu: 'Alkenler (Olefinler)', kapasite: 1 },
        { saat: '15:40 – 16:30', ders: 'Biyoloji', sinav: 'AYT', konu: 'Nükleik Asitler ve Kalıtım', kapasite: 1 },
      ],
    },
    ...
    },
    {
      ...
      saatler: [
        ...
        { saat: '14:00 – 14:50', ders: 'Fizik', sinav: 'TYT', konu: 'Isı ve Sıcaklık', kapasite: 1 },
        { saat: '14:50 – 15:40', ders: 'Kimya', sinav: 'TYT', konu: 'Asitler, Bazlar ve Tuzlar', kapasite: 1 },
        { saat: '15:40 – 16:30', ders: 'Fizik', sinav: 'AYT', konu: 'Sığa (Kapasite)', kapasite: 1 },
      ],
    },
    {
      gun: 'Çarşamba', tarih: '20 Mayıs', hafta: 2,
    ...
    },
    {
      gun: 'Perşembe', tarih: '21 Mayıs', hafta: 2,
      saatler: [
        { saat: '13:10 – 14:00', ders: 'Matematik', sinav: 'AYT', konu: 'Logaritmalı Eşitsizlikler', kapasite: 1 },
        { saat: '14:00 – 14:50', ders: 'Fizik', sinav: 'TYT', konu: 'Elektrik Akımı (Ohm Yasası)', kapasite: 0 },
        { saat: '14:50 – 15:40', ders: 'Kimya', sinav: 'TYT', konu: 'Kovalent Bağlar ve Etkileşimler', kapasite: 1 },
        { saat: '15:40 – 16:30', ders: 'Biyoloji', sinav: 'AYT', konu: 'Sindirim Sistemi', kapasite: 1 },
      ],
