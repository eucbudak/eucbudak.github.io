...
export const efelerProgrami: Program = {
  ...
  gunler: [
    ...
    },
    {
      ...
      saatler: [
        { saat: '13:10 – 14:00', ders: 'Matematik', sinav: 'TYT', konu: 'Sayı Problemleri', kapasite: 2, isFirst: true },
        { saat: '14:00 – 14:50', ders: 'Matematik', sinav: 'TYT', konu: 'Sayı Problemleri', kapasite: 2, isFirst: false },
        { saat: '14:50 – 15:40', ders: 'Fizik', sinav: 'TYT', konu: 'Newton\'ın Hareket Yasaları', kapasite: 1, isFirst: true },
        { saat: '15:40 – 16:30', ders: 'Kimya', sinav: 'TYT', konu: 'Atom Modelleri (TYT)', kapasite: 1, isFirst: true },
      ],
    },
    {
      gun: 'Çarşamba', tarih: '13 Mayıs', hafta: 1,
      saatler: [
        { saat: '13:10 – 14:00', ders: 'Matematik', sinav: 'AYT', konu: 'İki Kat (Yarım) Açı Formülleri', kapasite: 2, isFirst: true },
        { saat: '14:00 – 14:50', ders: 'Matematik', sinav: 'AYT', konu: 'İki Kat (Yarım) Açı Formülleri', kapasite: 2, isFirst: false },
        { saat: '14:50 – 15:40', ders: 'Fizik', sinav: 'AYT', konu: 'Düzgün Çembersel Hareket', kapasite: 1, isFirst: true },
    ...
    },
    {
      ...
      saatler: [
        ...
        { saat: '15:40 – 16:30', ders: 'Kimya', sinav: 'AYT', konu: 'Elektrot Potansiyelleri', kapasite: 1, isFirst: true },
      ],
    },
    {
      gun: 'Pazartesi', tarih: '18 Mayıs', hafta: 2,
      saatler: [
        { saat: '13:10 – 14:00', ders: 'Matematik', sinav: 'TYT', konu: 'Oran-Orantı Problemleri', kapasite: 2, isFirst: true },
        { saat: '14:00 – 14:50', ders: 'Matematik', sinav: 'TYT', konu: 'Oran-Orantı Problemleri', kapasite: 2, isFirst: false },
    ...
    },
    {
      ...
      saatler: [
        { saat: '13:10 – 14:00', ders: 'Matematik', sinav: 'AYT', konu: 'Logaritmalı Eşitsizlikler', kapasite: 2, isFirst: true },
        { saat: '14:00 – 14:50', ders: 'Matematik', sinav: 'AYT', konu: 'Logaritmalı Eşitsizlikler', kapasite: 2, isFirst: false },
        { saat: '14:50 – 15:40', ders: 'Fizik', sinav: 'TYT', konu: 'Isı ve Sıcaklık', kapasite: 1, isFirst: true },
        { saat: '15:40 – 16:30', ders: 'Kimya', sinav: 'AYT', konu: 'Atom Modelleri (AYT)', kapasite: 1, isFirst: true },
      ],
    },
    {
      ...
      saatler: [
        ...
        { saat: '14:50 – 15:40', ders: 'Fizik', sinav: 'AYT', konu: 'Akım Geçen Tele Manyetik Kuvvet', kapasite: 1, isFirst: true },
        { saat: '15:40 – 16:30', ders: 'Kimya', sinav: 'TYT', konu: 'Karışımlar ve Ayırma Yöntemleri', kapasite: 1, isFirst: true },
      ],
    },
    {
      gun: 'Perşembe', tarih: '21 Mayıs', hafta: 2,
      saatler: [
        { saat: '13:10 – 14:00', ders: 'Matematik', sinav: 'AYT', konu: 'Maksimum-Minimum Problemleri', kapasite: 2, isFirst: true },
        { saat: '14:00 – 14:50', ders: 'Matematik', sinav: 'AYT', konu: 'Maksimum-Minimum Problemleri', kapasite: 2, isFirst: false },
        { saat: '14:50 – 15:40', ders: 'Fizik', sinav: 'TYT', konu: 'Madde ve Özkütle', kapasite: 1, isFirst: true },
        { saat: '15:40 – 16:30', ders: 'Kimya', sinav: 'AYT', konu: 'Çözeltilerin Özellikleri', kapasite: 1, isFirst: true },
      ],
    },
    {
      gun: 'Cuma', tarih: '22 Mayıs', hafta: 2,
      saatler: [
        { saat: '13:10 – 14:00', ders: 'Matematik', sinav: 'TYT', konu: 'Emek (İşçi-Havuz) Problemleri', kapasite: 2, isFirst: true },
        { saat: '14:00 – 14:50', ders: 'Matematik', sinav: 'TYT', konu: 'Emek (İşçi-Havuz) Problemleri', kapasite: 2, isFirst: false },
        { saat: '14:50 – 15:40', ders: 'Fizik', sinav: 'AYT', konu: 'Sığa (Kapasite)', kapasite: 1, isFirst: true },
        { saat: '15:40 – 16:30', ders: 'Kimya', sinav: 'TYT', konu: 'Katılar ve Hal Değişimleri', kapasite: 1, isFirst: true },
      ],
    },
  ],
};
